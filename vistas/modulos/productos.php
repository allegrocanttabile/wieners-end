           ...
           <!--=====================================
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <textarea type="text" maxlength="900" rows="3" class="form-control input-lg descripcionProducto" placeholder="Ingresar descripción producto"></textarea>
            ...
            <div class="form-group">
              ...
              <p class="help-block">Tamaño recomendado 400px * 400px <br> Peso máximo de la foto 2MB</p>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4 col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg peso" min="0" step="any" value="1">
              ...
              <div class="col-md-4 col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg entrega" min="0" value="3">
           ...
           <!--=====================================
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <textarea type="text" maxlength="900" rows="3" class="form-control input-lg descripcionProducto"></textarea>
